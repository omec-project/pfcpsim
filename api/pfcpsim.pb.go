...
type CreateSessionRequest struct {
	...
	SdfFilter     []string `protobuf:"bytes,5,rep,name=sdfFilter,proto3" json:"sdfFilter,omitempty"`
	Qfi           int32    `protobuf:"varint,6,opt,name=qfi,proto3" json:"qfi,omitempty"` // Should be uint8
	GateStatus    bool     `protobuf:"varint,7,opt,name=gateStatus,proto3" json:"gateStatus,omitempty"`
}
...
func (x *CreateSessionRequest) GetGateStatus() bool {
	if x != nil {
		return x.GateStatus
	}
	return false
...
var file_pfcpsim_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x73, 0x64, 0x66, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x71, 0x66, 0x69, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x03, 0x71, 0x66, 0x69, 0x12, 0x1e, 0x0a, 0x0a, 0x67, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x67, 0x61, 0x74, 0x65, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xd2, 0x01, 0x0a, 0x14, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79,
