...
func main() {
	...
	n3Addr := getopt.StringLong("n3-addr", 'p', defaultN3Address, "The IPv4 address of the UPF's N3 interface")
	ueAddrPool := getopt.StringLong("ue-pool", 'u', defaultUEAddressPool, "The IPv4 prefix from which UE addresses will be drawn.")
	nodeBAddr := getopt.StringLong("gnb-addr", 'e', defaultNodeBAddress, "The IPv4 address of the NodeB")
