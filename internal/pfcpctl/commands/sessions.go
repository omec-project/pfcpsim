...
type commonArgs struct {
	...
	AppFilterString []string `short:"a" long:"app-filter" default:"any:any:any:allow" description:"Specify an application filter. Format: '{ip | udp | tcp | any}:{IPv4 Prefix | any}:{<lower-L4-port>-<upper-L4-port> | any}:{allow | deny}' . e.g. 'udp:10.0.0.0/8:80-88:allow'"`
